...
"VERSION 2 - 1D heat diffusion equation (McCormick, M. J. and Scavia, 1981) - Implicit Crank Nicolson scheme - Centered differences in space and time - Thomas algorithm" 
...
data = pd.read_excel('bathymetryTorrao.xlsx', index_col=0, header=0).iloc[:,[0,-1]]
...
Lake_initial_water_temperature = 7.0
