...
data = pd.read_excel('meteorologyCB_1989_2008.xlsx', sheet_name='1D', index_col=0, header=0).iloc[:,[0,1,2,-1]]
...
data = pd.read_excel('bathymetryCB.xlsx', index_col=0, header=0).iloc[:,[0,-1]]
...
Lake_initial_water_temperature = 15.0
